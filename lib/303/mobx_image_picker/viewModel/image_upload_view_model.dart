...
abstract class _ImageUploadViewModelBase with Store {
  static const _baseUlr = 'https://firebasestorage.googleapis.com/v0/b/fluttertr-ead5c.appspot.com/o/full%2Fvb.png';
  ...
  ImageUploadService imageUploadService = ImageUploadService(Dio(BaseOptions(baseUrl: _baseUlr)));
  ...
  void uploadImgUrl(ImageUploadResponse? response) {
    if (response == null) {
      imageUrl =
