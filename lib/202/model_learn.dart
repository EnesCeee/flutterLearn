...
//bu class eğer servisten beslenecekse en doğru yöntemdir.Bunşar null gelebilir
class PostModel8 {
  final int? userId;
  final int? id;
  final String? title;
  ...
  //copyWith yeni bir model atadığımda diğerini silmeeden diğer modele aktarır
}


//camel case kullanımının örneğidir